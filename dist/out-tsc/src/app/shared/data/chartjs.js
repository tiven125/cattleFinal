...
export var lineChartLabels = ['January', 'February', 'March', 'April', 'May', 'June', 'July'];
...
export var areaChartLabels = ['January', 'February', 'March', 'April', 'May', 'June', 'July'];
export var areaChartOptions = {
    animation: {
        duration: 1000,
        easing: 'easeOutBack'
    },
...
export var scatterChartLabels = ['January', 'February', 'March', 'April', 'May', 'June', 'July'];
export var scatterChartOptions = {
    animation: {
        duration: 1000,
        easing: 'easeOutBack'
    },
...
export var barChartLabels = ['2006', '2007', '2008', '2009', '2010', '2011', '2012'];
...
export var doughnutChartColors = [{ backgroundColor: ["rgba(0, 157, 160, 0.8)", "rgba(28, 188, 216, 0.8)", "rgba(255, 141, 96, 0.8)"] }];
...
// Radar
export var radarChartLabels = ['Eating', 'Drinking', 'Sleeping', 'Designing', 'Coding', 'Cycling', 'Running'];
export var radarChartData = [
    { data: [65, 59, 90, 81, 56, 55, 40], label: 'Series A' },
    { data: [28, 48, 40, 19, 96, 27, 100], label: 'Series B' }
];
export var radarChartType = 'radar';
export var radarChartColors = [
    {
        backgroundColor: ["rgba(255, 141, 96, 0.8)"]
    },
    {
...
// Pie
export var pieChartLabels = ['Download Sales', 'In-Store Sales', 'Mail Sales'];
export var pieChartData = [300, 500, 100];
export var pieChartType = 'pie';
export var pieChartColors = [{ backgroundColor: ["rgba(0, 157, 160, 0.8)", "rgba(28, 188, 216, 0.8)", "rgba(255, 141, 96, 0.8)"] }];
...
export var ploarChartColors = [{ backgroundColor: ["rgba(0, 157, 160, 0.8)", "rgba(28, 188, 216, 0.8)", "rgba(255, 141, 96, 0.8)", "rgba(12, 194, 126, 0.8)", "rgba(255, 88, 107, 0.8)"] }];
